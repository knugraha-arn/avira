...
function LoginContent() {
  ...
  async function handleGoogleLogin() {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        redirectTo: `https://avira.arranetwork.com/auth/callback`,
        queryParams: { hd: 'arranetwork.com' },
      },
    })
    if (error) {
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[520px] flex-col bg-brand-navy relative overflow-hidden shrink-0">
        ...
        <div className="relative flex flex-col h-full px-10 py-10">
          ...
          <div className="mt-auto mb-2">
            ...
            <p className="text-white/50 mt-2 text-sm leading-relaxed">Avira Risk Management · Sistem manajemen<br />risiko informasi terintegrasi</p>
