      ...
      <div className="flex-1 flex items-center justify-center bg-white px-6">
        <div className="w-full max-w-sm">
          ...
          <form action={signInWithGoogle}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-black/10 bg-white px-4 py-3.5 text-sm font-medium text-black hover:bg-brand-gray active:scale-95 transition-all shadow-sm"
            >
              <GoogleIcon />
              Masuk dengan Google
            </button>
